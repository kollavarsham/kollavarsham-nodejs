...
var Celestial = function (settings) {
  this.planetarySystem = new PlanetarySystem(settings.system);
};

Celestial.prototype.planetarySystem = null;
Celestial.prototype.backLastConjunctionAhargana = -1;
Celestial.prototype.backNextConjunctionAhargana = -1;
Celestial.prototype.backLastConjunctionLongitude = -1;
Celestial.prototype.backNextConjunctionLongitude = -1;
Celestial.prototype.ayanaDegree = 0;
Celestial.prototype.ayanaMinute = 0;

Celestial.prototype.threeRelation = function (left, center, right) {
...
Celestial.prototype.setAyanamsa = function (ahargana) {
...
Celestial.prototype.getTrueLongitude = function (ahargana, meanSolarLongitude, planet) {
...
Celestial.prototype.declination = function (longitude) {
...
Celestial.prototype.getSunriseTime = function (equationOfTime) {
  // TODO: Add Tests if/when feasible
...
Celestial.prototype.getSighraEquation = function (anomaly, planet) {
...
Celestial.prototype.getTithi = function (trueLunarLongitude, trueSolarLongitude) {
...
Celestial.prototype.getElong = function (ahargana) {
