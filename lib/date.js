...
KollavarshamDate.prototype.print = function () {
  if (this.globals) {
    var result = 'Saka : ' + pad(this.globals.YearSaka, 4) + '\t' + this.globals.masa + " (" +
        pad(this.globals.masa_num, 2) + ") " + this.globals.paksa + '\t' + pad(this.globals.tithi_day, 2) + '\n';
    result += 'Saura: ' + pad(this.globals.YearSaka, 4) + '\t' + this.globals.saura_masa + " (" +
        pad(this.globals.saura_masa_num, 2) + ") " + pad(this.globals.saura_masa_day, 2) + '\t' + this.globals.naksatra + '\n';
    result += 'ME   : ' + pad(this.globals.MalayalamYear, 4) + '\t' + this.globals.malayala_masa + " (" +
        pad(this.globals.malayala_masa_num, 2) + ") " + pad(this.globals.saura_masa_day, 2) + '\t' + this.globals.malayala_naksatra + '\n';
    return result;
  }
