 ...
 * @class kollavarsham
 * @static
 * @type {{settings: {bija: boolean, mode: number, latitude: number, longitude: number, output: string, gregorianDate: Date}, setMode: 'setMode', setBija: 'setBija', setLatitude: 'setLatitude', setLongitude: 'setLongitude', setOutput: 'setOutput', displaySettings: 'displaySettings', setInputDate: 'setInputDate'}}
 */
var kollavarsham = {
  settings          : {
