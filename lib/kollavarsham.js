...
var Kollavarsham = function (options) {
  ...
  var defaults = {
    ...
    longitude     : 75.8,
    outputformat  : 'verbose',
    gregorianDate : new Date()  //TODO: This does not need to be here. What about the KollavarshamDate
  };
...
Kollavarsham.prototype.fromGregorianDate = function (date) {
  ...
  globals.month = date.getMonth();
  globals.day = date.getDay();

  calculations.main(this._settings);
  calculations.planetary();

  var kollavarshamDate = new KollavarshamDate(globals.YearKali, globals.saura_masa_num, globals.saura_masa_day);
