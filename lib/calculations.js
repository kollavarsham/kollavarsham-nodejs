...
var calculations = {
  fromGregorian       : function (settings, gregorianDate) {
    ...
    globals.meanSolarLongitude = celestial.getMeanLongitude(ahar, celestial.YugaRotation.sun);
    ...
    celestial.PlanetMeanPosition.sun = globals.trueSolarLongitude;

    // mean and true moon at sunrise
    globals.meanLunarLongitude = celestial.getMeanLongitude(ahar, celestial.YugaRotation.moon);
    celestial.YugaRotation.moon = globals.meanLunarLongitude;
    ...
    // last conjunction
    globals.lastConjunctionLongitude = celestial.getLastConjunctionLongitude(ahar, tithi);

    // next conjunction
    globals.nextConjunctionLongitude = celestial.getNextConjunctionLongitude(ahar, tithi);
    ...
    for (var i = 0; i < planets.length; i++) {
      ...
      celestial.PlanetTruePosition[planets[i]] = celestial.getTrueLongitude(ahar, globals.meanSolarLongitude, planets[i]);
    }
