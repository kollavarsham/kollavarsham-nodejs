...
var calculations = {
  fromGregorian : function (settings) {
    ...
    var julianDay = calendar.gregorianDateToJulianDay(globals.gregorianDate);
    ...
    var equationOfTime = celestial.getDaylightEquation(globals.gregorianDate.getFullYear(), settings.latitude, ahar);
    ahar -= equationOfTime;
    ...
    // last conjunction
    globals.clong = celestial.getClong(ahar, globals.tithi);

    // next conjunction
    globals.nclong = celestial.getNclong(ahar, globals.tithi);
