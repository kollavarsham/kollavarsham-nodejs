...
var calculations = {
  ...
  planetary:function(){
    ...
    for (var id in  planets){
      celestial.PlanetMeanPosition[planets[id]] = celestial.getMeanLongitude(globals.ahar, celestial.PlanetRotation[planets[id]]);
      celestial.PlanetTruePosition[planets[id]] = celestial.getTrueLongitude(globals.ahar, globals.mslong, planets[id]);
    }
  }
};
