...
var calculations = {
  fromGregorian       : function (settings, gregorianDate) {
    ...
    globals.mlMalayalaMasa = calendar.getMlMalayalaMasaName(globals.malayalaMasaNum);
    ...
    globals.mlMalayalaNaksatra = calendar.getMlMalayalaNaksatraName(trueLunarLongitude);
    ...
    var malayalamYear = globals.YearSaka - 747 +
      math.truncate((globals.masaNum - globals.malayalaMasaNum + 12) / 12);
