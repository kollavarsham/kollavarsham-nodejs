...
var calculations = {
  ...
  fromGregorian       : function (settings, gregorianDate) {
    ...
    celestial.planetarySystem.planets.candrocca.MeanPosition = celestial.zero360(celestial.planetarySystem.planets.candrocca.MeanPosition);
    ...
    celestial.planetarySystem.planets.rahu.MeanPosition = celestial.zero360(celestial.planetarySystem.planets.rahu.MeanPosition);
