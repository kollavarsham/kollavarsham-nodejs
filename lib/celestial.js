...
var celestial = {
  ...
  getTrueLongitude      : function (ahargana, meanSolarLongitude, planet) {
    var mean_long1, mean_long2, mean_long3;
    var argument;
    ...
    mean_long1 = this.PlanetMeanPosition[planet] + equation1 / 2;
    argument = mean_long1 - this.PlanetApogee[planet];
    equation2 = this.getMandaEquation(argument, planet);

    // second manda correction
    mean_long2 = mean_long1 - equation2 / 2;
    argument = mean_long2 - this.PlanetApogee[planet];
    equation3 = this.getMandaEquation(argument, planet);

    // second sighra correction
    mean_long3 = this.PlanetMeanPosition[planet] - equation3;
    anomaly2 = this.getMeanLongitude(ahargana, this.PlanetSighra[planet]) - mean_long3;
    ...
    return this.zero360(mean_long3 + equation4 + equation5);
  },
