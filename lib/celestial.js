...
var celestial = {
  ...
  getClong              : function (ahar, tithi) {
    ...
    if (Math.abs(ahar - globals.backClongAhar) < 1) {
      return globals.backClong;
    } else if (Math.abs(ahar - globals.backNclongAhar) < 1) {
      globals.backClongAhar = globals.backNclongAhar;
      globals.backClong = globals.backNclong;
      return globals.backNclong;
    } else {
      globals.backClongAhar = ahar;
      globals.backClong = this.getConj(ahar);
      return globals.backClong;
    }
  },
  getNclong             : function (ahar, tithi) {
    ...
    if (Math.abs(ahar - globals.backNclongAhar) < 1) {
      return globals.backNclong;
    } else {
      globals.backNclongAhar = ahar;
      globals.backNclong = this.getConj(ahar);
      return globals.backNclong;
    }
  }
};
