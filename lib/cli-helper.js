...
var cliHelper = {
  ...
  helpMessage     : function () {
    ...
    console.log('    ' + chalk.blue.bold('-b --bija'));
    ...
    console.log('    ' + chalk.blue.bold('-b --bija [Boolean]'));
    console.log('    ' + '   Turn bija on or off. Default off.');
    console.log('    ' + chalk.gray('   \'-b true\' or \'--bija true\' is same as simply \'-b\' or \'--bija\''));
    console.log('    ' + chalk.gray('   \'-b false\' or \'--bija false\' is same as simply \'--no-bija\''));
  ...
  displaySettings : function (settings) {
    ...
    console.log(chalk.gray('Bija           : ' + settings.bija));
