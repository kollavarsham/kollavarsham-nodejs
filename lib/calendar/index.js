...
Calendar.prototype.sauraMasaNames = {
  0  : 'Mesa      ',
  1  : 'Vrsa      ',
  2  : 'Mithuna   ',
  3  : 'Karkata   ',
...
Calendar.prototype.malayalaMasaNames = {
  0  : 'Chingam   ',
  1  : 'Kanni     ',
  2  : 'Thulam    ',
  3  : 'Vrischikam',
...
Calendar.prototype.mlMalayalaMasaNames = {
  0  : 'ചിങ്ങം',
  1  : 'കന്നി',
  2  : 'തുലാം',
  3  : 'വൃശ്ചികം',
...
Calendar.prototype.malayalaNaksatras = {
  0  : 'Ashwathi',
  1  : 'Bharani',
  2  : 'Karthika',
  3  : 'Rohini',
...
Calendar.prototype.mlMalayalaNaksatras = {
  0  : 'അശ്വതി',
  1  : 'ഭരണി',
  2  : 'കാർത്തിക',
  3  : 'രോഹിണി',
...
Calendar.prototype.julianDayToMlWeekday = function (julianDay) {
  return this.mlWeekdays[math.truncate(julianDay + 0.5) % 7];
};
...
Calendar.prototype.getSauraMasaName = function (number) {
  return this.sauraMasaNames[number];
};

Calendar.prototype.getMalayalaMasaName = function (number) {
  return this.malayalaMasaNames[number];
};

Calendar.prototype.getMlMalayalaMasaName = function (number) {
  return this.mlMalayalaMasaNames[number];
};

Calendar.prototype.getNaksatraName = function (tllong) {
  return this.naksatras[math.truncate(tllong * 27 / 360)];
};

Calendar.prototype.getMalayalaNaksatraName = function (tllong) {
  return this.malayalaNaksatras[math.truncate(tllong * 27 / 360)];
};

Calendar.prototype.getMlMalayalaNaksatraName = function (tllong) {
  return this.mlMalayalaNaksatras[math.truncate(tllong * 27 / 360)];
};
