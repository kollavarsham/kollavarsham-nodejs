...
var calendar = {
  ...
  isTodaySauraMasaFirst    : function (ahargana) {
    ...
    */
    var trueSolarLongitudeToday = celestial.getTrueSolarLongitude(ahargana - globals.desantara);
    var trueSolarLongitudeTomorrow = celestial.getTrueSolarLongitude(ahargana - globals.desantara + 1);
